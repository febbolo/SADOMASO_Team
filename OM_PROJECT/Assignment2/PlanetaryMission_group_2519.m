...
Pert.case_names = { ...
    ...
    '50 RGT orbital periods (50T_{rgt})', ...
...
if strcmp(RUN_MODE, 'single')
    ...
    choice = input(['Which case you want to plot?\n' ...
        ...
        '3. 50 x RGT orbital periods (50T_{rgt})\n' ...
...
plotKepFiltered(COSMOS.tvec, kepCOSMOS, Primary.mu, "lowfreq");
...
plotKepFiltered(GPS_BIIR.tvec, kepGPS_BIIR, Primary.mu, "lowfreq");
